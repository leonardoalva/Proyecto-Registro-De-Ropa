...
function habilitarEdicion(productoId, campo) {
    ...
    productoElement.querySelector('.guardar-btn').addEventListener('click', () => {
        ...
        ProductosTotal.actualizarProducto(productoId, campo, nuevoValor);
        mostrarListado();
    });
...
function mostrarResultadosBusqueda(productos) {
    ...
    listado.innerHTML = ProductosTotal.map(productos => `
        <div class="producto">
            <p><strong>Linea:</strong> ${productos.linea}</p>
            <p><strong>Producto:</strong> ${productos.producto}</p>
